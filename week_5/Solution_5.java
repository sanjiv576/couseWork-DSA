/*
 * you are provided with an array A [] containing set of different words in the form of string and you are provided with targeted word,
 * return length of subset s from set A required to from targeted word by using combination of different letters of subset s.
...
public class Solution_5 {
    ...
    // stores each letter of the targeted word
    char searchLetter;

    // stores each word/element of the main array
    String word;

    // stores each letter of the elment of the main array
    char letter;

    // this contains subsets in the array form but also has duplicates elments
